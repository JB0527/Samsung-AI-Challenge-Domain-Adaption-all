...
csv_name = 'cLAST'
img_save_dir = 'cLAST'
sample_df13 = "13ensemble_sample_submission.csv" 
thread_num = 30
...
def apply_ellipse_filter(input_image):
    ...
    ellipse_width = 1800//2
    ellipse_height = 1250//2
...
if __name__ == '__main__':
    sample_df13 = pd.read_csv(sample_df13)
    num_samples = len(sample_df13)
    num_samples_per_group = 13
